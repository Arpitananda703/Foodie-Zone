    ...
    <ScrollView style={{ marginTop: 50 }}>
      {total > 0 ? (
        <>
          ...
          <View style={{justifyContent:'center',alignItems:'center',width:'30%',borderWidth:1,height:35,alignItems:'center',left:'65%',marginTop:20}}>
            <TouchableOpacity>
              <Text style={{fontSize:17,color:'red',fontWeight:'bold'}}>Order Now⚡</Text>
            </TouchableOpacity>
          </View>
        </>
      ) : (
